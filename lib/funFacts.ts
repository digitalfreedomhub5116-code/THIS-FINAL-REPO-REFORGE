export const FUN_FACTS = [
  ...
  'We are constantly adding new workout quests and features just for you.',
  ...
  'Fun fact: The developer drank an unreasonable amount of coffee just to format the workouts and visual tutorials you are about to watch.',
