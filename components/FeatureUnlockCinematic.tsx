  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(${currentFeature?.color || '#c084fc'}08 1px, transparent 1px), linear-gradient(90deg, ${currentFeature?.color || '#c084fc'}08 1px, transparent 1px)`,
        ...
        {phase === 'alert' && (
          ...
          >
            <motion.div
              ...
              style={{ color: currentFeature?.color || '#c084fc' }}
            >
              ── SYSTEM ALERT ──
            </motion.div>
            ...
            <motion.div
              ...
              style={{
                background: `radial-gradient(circle, ${currentFeature?.color || '#c084fc'}25, transparent 70%)`,
                border: `2px solid ${currentFeature?.color || '#c084fc'}40`,
                boxShadow: `0 0 40px ${currentFeature?.glow || 'rgba(192,132,252,0.3)'}`,
              }}
            >
              <Unlock size={36} style={{ color: currentFeature?.color || '#c084fc' }} />
            </motion.div>
