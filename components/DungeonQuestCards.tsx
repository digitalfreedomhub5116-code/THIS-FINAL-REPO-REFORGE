    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <img
          ...
          style={{ objectPosition: target.exercise === 'SITUPS' ? 'center 50%' : 'center 15%', opacity: imgLoaded ? (isCompleted ? 0.3 : 1) : 0, filter: isOverlayEnabled ? (isCompleted ? 'grayscale(100%) brightness(0.3)' : 'grayscale(100%) brightness(0.4)') : (isCompleted ? 'grayscale(100%) brightness(0.4)' : 'grayscale(100%) brightness(0.9)') }}
