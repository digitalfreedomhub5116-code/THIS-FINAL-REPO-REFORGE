  ...
  return (
    <div className="fixed inset-0 bg-[#07070f] flex items-center justify-center overflow-y-auto"
      ...
      <AnimatePresence>
        {loading && (
          ...
          >
            ...
            <div className="glitch-text text-gray-400 text-xs text-center" data-text={mode === 'CREATE' ? 'Creating your account...' : 'Signing you in...'}>{mode === 'CREATE' ? 'Creating your account...' : 'Signing you in...'}</div>
            <AnimatePresence mode="wait">
              <motion.p
                key={factIndex}
                initial={{ opacity: 0, y: 8 }}
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-[-15%] left-[20%] w-[500px] h-[500px] bg-[#00d4ff]/6 rounded-full blur-[140px]" />
        <div className="absolute bottom-[-10%] right-[10%] w-[400px] h-[400px] bg-[#00d4ff]/5 rounded-full blur-[120px]" />
        ...
        <div className="text-center mb-8">
          <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }}>
            <h1 className="text-4xl font-black tracking-tight text-white mb-1">
              RE<span style={{ color: '#00d4ff' }}>FORGE</span>
            </h1>
            ...
            {mode === 'CREATE' && (
              ...
              >
                ...
                <form onSubmit={handleCreate} className="flex flex-col gap-3">
                  <div>
                    <label className={labelClass}>
                      Codename <span className="text-[#00d4ff]">*</span>
                    </label>
                    <input
                      type="text"
                      value={username}
                  ...
                  <div>
                    <label className={labelClass}>
                      Password <span className="text-[#00d4ff]">*</span>
                    </label>
                    <div className="relative">
                      <input
                        type={showPass ? 'text' : 'password'}
                  ...
                  <div>
                    <label className={labelClass}>
                      Confirm Password <span className="text-[#00d4ff]">*</span>
                    </label>
                    <div className="relative">
                      <input
                ...
                <p className="text-center text-white/25 text-xs mt-4">
                  ...
                  <button
                    onClick={() => switchMode('SIGN_IN')}
                    className="text-[#00d4ff] hover:text-[#00d4ff] transition-colors font-medium"
                  >
                    Sign in
                  </button>
                </p>
