    ...
    <div className="fixed inset-0 z-[100] bg-black flex flex-col items-center justify-center p-6 font-mono">
      ...
      >
        ...
        <div className="flex justify-center mb-6">
          <div className="w-16 h-16 rounded-2xl flex items-center justify-center" style={{ background: 'rgba(0,212,255,0.08)', border: '1px solid rgba(0,212,255,0.2)', boxShadow: '0 0 30px rgba(0,212,255,0.1)' }}>
        ...
        <div className="space-y-3 mb-8">
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-lg flex items-center justify-center" style={{ background: 'rgba(0,212,255,0.1)', border: '1px solid rgba(0,212,255,0.2)' }}>
        ...
        >
          <div
            className={`w-5 h-5 rounded border-2 flex items-center justify-center transition-all mt-0.5 flex-shrink-0 ${
              agreed ? 'bg-[#00d4ff] border-[#00d4ff]' : 'bg-transparent border-gray-600'
            }`}
          >
            {agreed && <Check size={13} className="text-black" strokeWidth={3} />}
          </div>
          <span className="text-xs text-gray-400 leading-relaxed">
            I have read and agree to the <span className="text-[#00d4ff] font-bold">Privacy Policy</span> and{' '}
            <span className="text-[#00d4ff] font-bold">Terms & Conditions</span>.
          </span>
        </div>
