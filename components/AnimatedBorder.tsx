...
const BorderPrismatic: React.FC<{ color: string; glow: string }> = ({ glow }) => (
  <>
    ...
    <motion.div
      ...
      style={{
        background: 'conic-gradient(from 0deg, #f87171, #fbbf24, #4ade80, #06b6d4, #8b5cf6, #ec4899, #f87171)',
        mask: 'linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)',
        WebkitMask: 'linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)',
        maskComposite: 'exclude',
        WebkitMaskComposite: 'xor',
    ...
    <motion.div
      ...
      animate={{
        boxShadow: [
          ...
          `inset 0 0 25px rgba(139,92,246,0.2), 0 0 20px rgba(139,92,246,0.15)`,
          `inset 0 0 25px rgba(248,113,113,0.2), 0 0 20px rgba(248,113,113,0.15)`,
        ],
      }}
      ...
      {[0, 90, 180, 270].map((deg) => (
        <div
          ...
          style={{
            ...
            transformOrigin: '0 0',
            background: ['#f87171', '#fbbf24', '#4ade80', '#8b5cf6'][deg / 90],
            boxShadow: `0 0 8px ${['#f87171', '#fbbf24', '#4ade80', '#8b5cf6'][deg / 90]}`,
            filter: `blur(0.5px)`,
          }}
        />
      ))}
