        ...
        >
          ...
          <div className="flex gap-2">
            ...
            <motion.button
              ...
              className="flex-1 flex items-center justify-center gap-2 py-3.5 bg-system-neon text-black rounded-xl text-sm font-black uppercase tracking-widest hover:bg-white transition-all shadow-[0_0_20px_rgba(0,212,255,0.3)]"
            >
