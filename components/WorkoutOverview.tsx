...
const HolographicBody: React.FC<{ focus: string; isCardio: boolean; videos: Record<string, string> }> = ({ focus, isCardio, videos }) => {
  ...
  return (
    <div className="relative w-full h-[400px] sm:h-[440px] md:h-[480px] flex items-center justify-center overflow-hidden bg-black rounded-lg perspective-1000 group border border-gray-800">
      ...
      {/* Background Grid */}
      <div className="absolute inset-0 bg-[linear-gradient(rgba(0,212,255,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(0,212,255,0.05)_1px,transparent_1px)] bg-[size:30px_30px] opacity-20 pointer-events-none z-10" />
      ...
      <motion.div 
        ...
        className="absolute w-full h-2 bg-gradient-to-b from-transparent via-system-neon/40 to-transparent z-20 pointer-events-none shadow-[0_0_15px_rgba(0,212,255,0.4)]"
      />
      ...
      >
          <div className="flex items-center gap-2 text-[10px] font-mono text-system-neon font-bold bg-black/80 px-3 py-1.5 rounded border border-system-neon/30 backdrop-blur-sm shadow-[0_0_15px_rgba(0,212,255,0.2)]">
    ...
    return (
        ...
        >
            <div className={`w-12 h-12 rounded flex items-center justify-center relative overflow-hidden shrink-0 ${hasVideo ? 'bg-gradient-to-br from-system-neon/20 to-black border border-system-neon/30' : 'bg-black border border-gray-700'}`}>
                <div className="absolute inset-0 bg-[linear-gradient(45deg,transparent_25%,rgba(0,212,255,0.08)_50%,transparent_75%)] bg-[length:250%_250%] animate-[shimmer_2s_infinite]" />
