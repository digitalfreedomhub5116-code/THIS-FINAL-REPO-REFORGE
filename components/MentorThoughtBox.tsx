...
const TypewriterText: React.FC<{ text: string }> = ({ text }) => {
  ...
  return (
    <span style={{ 
      ...
      textShadow: glitch ? '2px 0 #00d4ff, -2px 0 #ff0040' : 'none',
        ...
        {currentMessage && (
          ...
          >
            <div className="relative">
              <div className="bg-[#0A0A0F]/90 border border-[#00d4ff]/30 px-3 py-2 rounded-lg shadow-[0_0_20px_rgba(0,212,255,0.15)] backdrop-blur-md">
                <div className="text-[8px] text-[#00d4ff]/80 font-black font-mono tracking-[0.3em] uppercase mb-1 flex items-center gap-1">
                  <div className="w-1 h-1 bg-[#00d4ff] rounded-full animate-pulse shadow-[0_0_4px_#00d4ff]" />
                  DUSK
                </div>
              ...
              <div className="absolute -left-2 bottom-4 w-4 h-4 bg-[#0A0A0F]/90 border-b border-l border-[#00d4ff]/30 transform rotate-45 backdrop-blur-md -z-10" />
            </div>
          </motion.div>
        )}
      </AnimatePresence>
