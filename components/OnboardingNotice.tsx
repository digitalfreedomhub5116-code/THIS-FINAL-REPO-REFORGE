      ...
      {visible && (
        ...
        >
          <motion.div
            ...
            style={{ background: '#0a0a14', border: '1px solid rgba(0,212,255,0.25)', maxHeight: '80vh' }}
          >
            {/* Close button */}
            <button
              onClick={handleClose}
            ...
            <div className="px-5 pt-5 pb-3 relative">
              <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse at 50% 0%, rgba(0,212,255,0.12) 0%, transparent 65%)' }} />
              ...
              <div className="relative flex items-center gap-2.5">
                ...
                <div>
                  <div className="text-[9px] font-mono font-bold tracking-[0.3em] uppercase text-[#00d4ff]/70">GUIDE</div>
            ...
            <div className="px-5 py-4 border-t border-white/[0.05]" style={{ background: 'rgba(0,0,0,0.4)' }}>
              <div className="flex items-center justify-between gap-3">
                ...
                <button
                  ...
                  style={{ background: 'linear-gradient(135deg, rgba(0,212,255,0.3), rgba(109,40,217,0.5))', color: '#c4b5fd', border: '1px solid rgba(0,212,255,0.4)' }}
                >
                  GOT IT
                </button>
              </div>
