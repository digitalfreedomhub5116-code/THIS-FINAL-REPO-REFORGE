                  ...
                  {ROLES.map(r => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <r.Icon className={`w-5 h-5 ${active ? 'text-cyan-400' : 'text-gray-500'}`} />
                        </div>
                  ...
                  <div className="rounded-xl p-3" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <button
                        ...
                        className={`w-10 h-5 rounded-full transition-colors relative ${weekendDifferent ? 'bg-cyan-500' : 'bg-gray-700'}`}
                      >
                        <motion.div
                      ...
                      <div className="rounded-xl p-3" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <button
                            ...
                            className={`w-10 h-5 rounded-full transition-colors relative ${coachingEnabled ? 'bg-cyan-500' : 'bg-gray-700'}`}
                          >
                            <motion.div
                              className="w-4 h-4 rounded-full bg-white absolute top-0.5"
                    ...
                    <div className="space-y-1.5">
                      {WORKOUT_OPTIONS.map(w => (
                        ...
                        >
                          ...
                          <span className={`text-xs font-mono ${preferredWorkoutTime === w.id ? 'text-cyan-300' : 'text-gray-400'}`}>{w.label}</span>
                          {preferredWorkoutTime === w.id && <Check className="w-3.5 h-3.5 text-cyan-400 ml-auto" />}
                        </button>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="rounded-xl p-3" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className={`w-10 h-5 rounded-full transition-colors relative ${napEnabled ? 'bg-cyan-500' : 'bg-gray-700'}`}
                      >
                        <motion.div
                          className="w-4 h-4 rounded-full bg-white absolute top-0.5"
              ...
              <motion.div key="review" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
                <div className="space-y-3 mb-5">
                  ...
                  <div className="rounded-xl p-3" style={{ background: 'rgba(34,211,238,0.04)', border: '1px solid rgba(34,211,238,0.1)' }}>
                    <div className="text-[9px] font-mono text-cyan-400 uppercase mb-1">Role</div>
