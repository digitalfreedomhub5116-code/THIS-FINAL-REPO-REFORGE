...
const ThreeHologram: React.FC<{ activeMuscle: string }> = ({ activeMuscle }) => (
    <div className="w-full h-full relative">
        ...
        <div className="absolute inset-0 pointer-events-none bg-[linear-gradient(rgba(0,212,255,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(0,212,255,0.05)_1px,transparent_1px)] bg-[size:40px_40px] opacity-20" />
    </div>
);
