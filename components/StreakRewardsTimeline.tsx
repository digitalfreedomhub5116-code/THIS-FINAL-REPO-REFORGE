...
const AvatarMarker: React.FC<{ progress: number }> = ({ progress }) => (
  ...
  >
    ...
    <div
      ...
      style={{ background: 'linear-gradient(90deg, transparent, rgba(0,212,255,0.3))', filter: 'blur(4px)' }}
    />
  </motion.div>
);
    ...
    >
      ...
      <div className="px-5 pt-4 pb-2 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className="text-[10px] font-black tracking-[0.2em] text-[#00d4ff]">
            STREAK REWARDS
          </div>
          {unclaimedCount > 0 && (
            <motion.div
      ...
      <div className="relative">
        ...
        <AnimatePresence>
          {showArrow && checkpoints.length > 4 && (
            ...
            >
              <ChevronRight size={16} style={{ color: 'rgba(0,212,255,0.4)' }} />
            </motion.div>
          )}
        </AnimatePresence>
