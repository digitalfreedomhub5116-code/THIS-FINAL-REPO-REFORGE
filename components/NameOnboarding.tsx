      ...
      >
        <div className="space-y-6">
          ...
          <button
            ...
            className="w-full py-4 bg-system-neon text-black rounded-xl text-xs font-black uppercase tracking-wider hover:scale-[1.02] shadow-[0_0_20px_rgba(126,184,212,0.4)] transition-all"
          >
            LOCK IN REGION
          </button>
        </div>
