...
const SystemGlitchBadge: React.FC<SystemGlitchBadgeProps> = ({ className }) => {
  ...
  return (
    <motion.div 
      animate={controls}
      className={`absolute -top-1 -right-1 z-50 flex h-4 w-4 items-center justify-center rounded-full bg-violet-600 ring-1 ring-violet-400 shadow-[0_0_8px_rgba(0,212,255,0.8)] ${className || ''}`}
    >
