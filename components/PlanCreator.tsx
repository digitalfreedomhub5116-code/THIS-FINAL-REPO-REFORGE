                ...
                <div className="max-w-3xl mx-auto space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <button 
                            ...
                            className="py-4 bg-system-neon text-black font-black text-xs uppercase tracking-widest rounded-xl hover:bg-white transition-all flex items-center justify-center gap-2 shadow-[0_0_15px_rgba(0,212,255,0.3)]"
                        >
